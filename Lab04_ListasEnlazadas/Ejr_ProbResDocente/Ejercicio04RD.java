...
/*. Ejercicio 04: Implemente una lista enlazada donde se pueda borrar 
un elemento por el elemento y la posición */
...
public static Ejercicio04RD insert(Ejercicio04RD list, int data) {
...
public static void printList(Ejercicio04RD list) {
...
public static Ejercicio04RD deleteByKey(Ejercicio04RD list, int key) {
...
public static Ejercicio04RD deleteAtPosition(Ejercicio04RD list, int index) {
...
Ejercicio04RD list = new Ejercicio04RD();
//
// ******INSERCIÓN******
//
// Inserta los valores
