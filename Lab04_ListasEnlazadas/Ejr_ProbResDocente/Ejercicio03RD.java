...
/*Ejercicio 03: Implementa una lista enlazada donde se pueda borrar 
...
public static Ejercicio03RD insert(Ejercicio03RD list, int data) {
...
public static void printList(Ejercicio03RD list) {
...
public static Ejercicio03RD deleteAtPosition(Ejercicio03RD list, int index) {
...
Ejercicio03RD list = new Ejercicio03RD();
//
// ******INSERCION******
//
// Inserta los valores
