...
/*. Ejercicio 2: Implementa una lista enlazada donde se pueda borrar 
un elemento por el elemento */
...
public static Ejercicio02RD insert(Ejercicio02RD list, int data) {
...
public static void printList(Ejercicio02RD list) {
...
public static Ejercicio02RD deleteByKey(Ejercicio02RD list, int key) {
...
Ejercicio02RD list = new Ejercicio02RD();
//
// ******INSERCIÓN******
//
// Inserta los valores
